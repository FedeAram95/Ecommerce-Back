...
import com.ecommerce.ecommerce.autenticacion.exceptions.TokenException;
...
public class IniciarSesionController {
     ...
     */
    @PostMapping("/login")
    public ResponseEntity<?> signin( @RequestBody IniciarSesionRequest iniciarSesionRequest, BindingResult result) {
